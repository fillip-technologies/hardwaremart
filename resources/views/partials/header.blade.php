...
<nav x-data="{ mobileMenu: false }"
    ...
    <div class="hidden md:flex items-center space-x-6 text-gray-700 pr-6">
        <a href="/login" class="relative flex flex-col items-center text-white">
            <i class="far fa-user text-lg"></i>
            <span class="mt-1 text-xs">Account</span>
        </a>

        <a href="/wishlist" class="relative flex flex-col items-center text-white">
        ...
        <a href="/cart" class="relative flex flex-col items-center text-white">
    ...
    <div class="absolute top-full left-0 w-full md:hidden z-40">

        <div x-cloak x-show="mobileMenu" x-transition.opacity.duration.200ms class="bg-white shadow-md">
