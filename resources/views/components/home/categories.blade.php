<div class="hidden md:flex justify-center bg-white shadow-sm py-3 space-x-8 text-secondary text-lg font-light">
    ...
    <div x-data="{ open: false }" class="relative">
        <div @click.prevent="open = !open" class="cursor-pointer flex flex-col items-center">
            <img src="/images/categories/eight.webp" alt="Automotive" class="w-8 h-8 object-cover rounded-full mb-1">
            <div class="flex items-center space-x-1 hover:text-primary">
