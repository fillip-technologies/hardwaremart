<section class="bg-gray-50 py-auto flex items-center justify-center py-28 px-6">
    <div class="bg-white shadow-lg rounded p-10 w-xl text-center border border-pink-100">
        ...
        <div class="flex justify-center mb-6">
            <div class="w-20 h-20 bg-primary/10 text-primary flex items-center justify-center rounded-full">
        ...
        <p class="text-gray-600 mb-6">Your jewelry will be on its way soon <i class="fa-solid fa-splotch"></i></p>
